...
import type { GeneratedAppRenderContext, GeneratedAppRenderer } from "./types.js";

export const crudWorkflowRenderer: GeneratedAppRenderer = {
  archetype: "crud-workflow",
  renderFiles: renderCrudWorkflowAppFiles,
};

export function renderCrudWorkflowAppFiles(context: GeneratedAppRenderContext, appSpec: AppSpec): Record<string, string> {
  return {
    ...
    "app/README.md": appReadme(context.runId, appSpec),
  };
}
